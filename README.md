...
# מערכת GUI לניהול מאפייה – מסך פתיחה
...
💡 כל אחד מהמסכים מעוצב בצורה נוחה למשתמש, עם ממשק גרפי מלא שמאפשר שליטה קלה ונוחה על הנתונים במאפייה.


---

## 🧑‍💼 מסך ניהול עובדים – פעולות CRUD
...
- לחיצה על כפתור "הוספת עובד" תפתח טופס להזנת פרטי העובד:
  ...
  - **Dropdown לבחירת סניף** מתוך רשימת סניפים קיימת.
  - **Dropdown לבחירת תפקיד** מתוך רשימת תפקידים.
...
💡 ממשק נוח ואינטואיטיבי לניהול מלא של עובדי המאפייה.


---

## 🥐 מסך ניהול מוצרי מאפה – פעולות CRUD על טבלה משולבת

מסך ניהול מוצרי המאפה מאפשר לנהל נתונים מתוך שלוש טבלאות שונות באמצעות טבלה אחת משולבת (JOIN). הטבלאות הן:

- **BakedGoods** – טבלת מוצרי המאפה
- **Categories** – טבלת קטגוריות
- **NutritionFacts** – טבלת ערכים תזונתיים
...
- לחיצה על כפתור "הוסף מוצר" פותחת טופס להזנת פרטי המוצר, כולל:
  ...
  - **Dropdown לבחירת הקטגוריה** מתוך טבלת הקטגוריות.
...
- לחיצה על "מחק מוצר" תבצע מחיקה מתוך **BakedGoods בלבד**.
  - אין צורך למחוק ידנית מטבלאות הקשורות, בזכות הגדרה של:
    - `ON DELETE CASCADE` על המפתחות הזרים.
...
💡 פעולות ההוספה והעדכון כוללות תמיד עדכון סינכרוני של הטבלאות:
- `BakedGoods`  
- `NutritionFacts`

בזכות ארכיטקטורה זו ניתן לנהל את מוצרי המאפה בצורה שלמה, נוחה ומדויקת.


---
## 📊 מסך דוחות ושאילתות – SELECT, UPDATE, DELETE עם תמיכה ב־Transactions
...
1. **Sidebar – סרגל צד לניהול והרצת השאילתות**
2. **תיבת תוצאות – הצגת פלטי השאילתות המורצות**

---

### 🧩 Sidebar – סרגל צד לשאילתות
