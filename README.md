...
[הוראות להפעלת האפליקציה](Stage5/Instructions%20for%20using%20the%20app)
...
מסך ניהול העובדים מאפשר לבצע מגוון פעולות על טבלת העובדים בבסיס הנתונים, ומחולק לשני אזורים עיקריים:


#### ✏️ חלק ראשון – פעולות על טבלת העובדים
...
המסך מחולק לשני אזורים עיקריים:


#### ✏️ חלק ראשון – פעולות על המוצרים
